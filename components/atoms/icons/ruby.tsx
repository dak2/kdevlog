const Ruby = () => {
  return (
    <svg viewBox="0 0 128 128">
      ...
      <path
        fill="url(#a)"
        d="M97.078 83.214l-68.738 40.817 89.003-6.04 6.855-89.745z"
      ></path>
      <linearGradient
        id="b"
        gradientUnits="userSpaceOnUse"
      ...
      <path
        fill="url(#f)"
        d="M121.275 43.047l-34.849-28.462-9.704 31.373z"
      ></path>
      <linearGradient
        id="g"
        gradientUnits="userSpaceOnUse"
      ...
      <path
        fill="url(#g)"
        d="M104.978 4.437l-20.497 11.327-12.93-11.479z"
      ></path>
      <linearGradient
        id="h"
        gradientUnits="userSpaceOnUse"
      ...
      <path fill="url(#h)" d="M3.802 100.034l8.586-15.659-6.946-18.655z"></path>
      <path
        fill="#fff"
        d="M4.981 65.131l6.987 19.821 30.365-6.812 34.667-32.218 9.783-31.075-15.403-10.878-26.19 9.802c-8.252 7.675-24.263 22.86-24.84 23.146-.573.291-10.575 19.195-15.369 28.214z"
      ></path>
      <linearGradient
        id="i"
        gradientUnits="userSpaceOnUse"
      ...
      <path
        fill="url(#n)"
        d="M42.589 77.897l18.57 35.828c10.98-5.955 19.579-13.211 27.454-20.983l-46.024-14.845z"
      ></path>
      <linearGradient
        id="o"
        gradientUnits="userSpaceOnUse"
      ...
      <path
        fill="url(#p)"
        d="M86.384 14.67l36.891 5.177c-1.969-8.343-8.015-13.727-18.32-15.41l-18.571 10.233z"
      ></path>
    </svg>
  );
};
